    ...
    <main className="min-h-screen bg-gray-50 pt-24 pb-24">
      ...
      <section className="bg-brand-primary text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 tracking-wider">提携・取引先</h1>
      ...
      <section className="container mx-auto px-6 lg:px-12 mt-16 max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
           <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">寺院 / 納骨堂 / 霊園</h3>
           ...
           <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">石材店</h3>
           ...
           <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">船舶事業者</h3>
           ...
           <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">遺骨メンテナンス・手元供養</h3>
