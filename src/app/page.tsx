...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white flex flex-col">
      ...
      {/* ============================================================
          1. HERO — 深度ズーム + ノイズ + GSAP行別テキスト
          ============================================================ */}
      <section
        className="hero-grain relative w-full h-[90vh] min-h-[600px] flex items-end justify-start overflow-hidden bg-gray-900"
        aria-label="メインビジュアル"
      >
        {/* Hero背景：深度ズームアニメーション */}
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="穏やかな海の水平線の写真"
            fill
            className="object-cover opacity-80 hero-zoom"
            priority
            sizes="100vw"
          />
          {/* 視線誘導グラデ：左下にテキストを置くためのオーバーレイ */}
          <div className="absolute inset-0 bg-gradient-to-t from-gray-950/80 via-gray-900/30 to-gray-900/10" />
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-16 pb-20 md:pb-28">
          ...
          <p
            data-hero-line=""
            className="text-white/60 font-medium tracking-[0.28em] mb-6 text-xs md:text-sm uppercase flex items-center gap-3"
            style={{ opacity: 0 }}
          >
          ...
          {/* H1：1行ずつGSAPアニメーション */}
          <h1 className="font-serif font-bold text-white leading-[1.1] mb-8 tracking-[0.05em]">
            <span
              data-hero-line=""
            ...
            <span
              data-hero-line=""
              className="block text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-white/90"
              style={{ opacity: 0 }}
            >
              確かな判断と実務を。
            </span>
          ...
          <p
            data-hero-line=""
            className="text-base md:text-lg text-gray-300 mb-12 max-w-xl leading-[1.9] font-light"
            style={{ opacity: 0 }}
          >
          ...
          >
            ...
            <Link
              href="/contact"
              className="px-8 py-4 bg-transparent border border-white/30 text-white font-bold text-base hover:bg-white/10 hover:border-white/60 transition-all duration-300 hover:-translate-y-0.5"
            >
              お問い合わせ
            </Link>
          </div>
        ...
        >
          ...
          <div className="w-[1px] h-16 overflow-hidden relative bg-white/10">
            <div
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <section className="py-40 bg-neutral-surface" aria-labelledby="about-heading">
        <div className="container mx-auto px-6 lg:px-16">
          <div className="relative flex flex-col lg:flex-row lg:items-center">

            {/* Text Block（左：画像に重なる白ボックス） */}
            <div className="lg:w-5/12 z-10 relative mt-8 lg:mt-0 order-2 lg:order-1">
              <div className="lg:bg-white/90 lg:backdrop-blur-md lg:p-14 lg:shadow-2xl lg:-mr-40 relative z-20">
                ...
                <div
                  className="reveal prose prose-lg text-gray-600 leading-[2.2]"
            ...
            {/* Image Block（右：大きくオフセット・subtle zoom） */}
            <div className="lg:w-7/12 w-full lg:ml-auto order-1 lg:order-2">
              <div
                className="reveal clip-reveal relative overflow-hidden group h-[420px] lg:h-[700px]"
                style={{ transitionDelay: '0.1s' }}
              >
                <Image
        ...
        <div className="container mx-auto px-6 lg:px-16">
          <div className="reveal mb-14">
            ...
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
              <h2
                id="business-heading"
                className="text-4xl md:text-5xl font-serif font-bold text-gray-900 tracking-[0.05em]"
              >
                事業領域
              </h2>
      ...
      <section className="py-40 bg-slate-50" aria-labelledby="strength-heading">
        <div className="container mx-auto px-6 lg:px-16">
          <div className="reveal text-center mb-20">
            ...
            <h2
              id="strength-heading"
              className="text-4xl md:text-5xl font-serif font-bold text-gray-900 tracking-[0.05em] mb-4"
            >
              清蓮が選ばれる理由
            </h2>
            ...
            {[
              {
                id: '01',
                title: '実務対応力',
                desc: '相談で終わらせず、手続き・段取り・実務まで一貫して対応。判断と実務を分けない姿勢が、負担を最小化します。',
              },
              {
                id: '02',
                title: '提携ネットワーク',
                desc: '国内寺院・石材店・船舶事業者など、国内外の専門事業者と強固な連携体制を構築しています。',
              },
              {
                id: '03',
                title: '来店型相談',
                desc: '完全予約制の来店相談により、個別事情を丁寧にお聞きします。最適な選択肢を一緒に考えます。',
              },
            ].map((item, idx) => (
              <div
                key={item.id}
              ...
              >
                <span className="text-6xl font-serif font-bold text-gray-100 mb-6 block tracking-widest leading-none">
                  {item.id}
                </span>
                <h3 className="text-xl font-bold mb-4 text-gray-900 tracking-wide border-b-2 border-brand-primary pb-3 self-start">
                  {item.title}
                </h3>
        ...
        <div className="container mx-auto px-6 lg:px-16">
          <div className="flex flex-col lg:flex-row gap-16 items-start justify-between">
            <div className="lg:w-1/3 reveal">
              ...
              <h2
                id="partner-heading"
                className="text-3xl md:text-4xl font-serif font-bold text-gray-900 mb-6 tracking-[0.05em]"
              >
                提携・取引先
              </h2>
              ...
              <Link
                href="/partner"
                className="inline-flex items-center gap-2 text-sm font-bold text-brand-primary hover:text-brand-hover transition-colors"
              >
                提携事業者一覧へ
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
            ...
            <div className="lg:w-2/3 grid grid-cols-2 md:grid-cols-4 gap-[1px] bg-gray-200">
              {['寺院 / 納骨堂', '石材店', '船舶事業者', '遺骨関連専門'].map((p, i) => (
                <div
                  key={i}
                  data-stagger="partners"
                  className="reveal bg-white text-center p-8 flex items-center justify-center font-bold text-gray-700 text-sm hover:text-brand-primary transition-colors duration-200"
                >
                  {p}
                </div>
              ))}
        ...
        <div className="container mx-auto px-6 lg:px-16">
          <div className="reveal mb-10 flex items-end justify-between">
            <div>
              ...
              <h2
                id="news-heading"
                className="text-3xl md:text-4xl font-serif font-bold text-gray-900 tracking-[0.05em]"
              >
                ニュース・お知らせ
              </h2>
            </div>
            <Link
              href="/contact"
              className="hidden md:inline-flex items-center gap-1.5 text-sm font-bold text-brand-primary hover:text-brand-hover transition-colors"
            >
              一覧を見る
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
            ...
            {newsData[activeTab]?.length > 0 ? (
              <div className="divide-y divide-gray-100">
                {newsData[activeTab].map((item, idx) => (
                  <div
                    key={idx}
                    className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6 px-6 py-4 hover:bg-gray-50 transition-colors cursor-pointer group"
                  >
                    <span className="text-xs text-gray-400 font-medium tracking-widest flex-shrink-0">{item.date}</span>
                    <span
                      className={`text-[10px] font-bold px-2.5 py-0.5 flex-shrink-0 w-fit ${
                        categoryColor[item.category] ?? 'bg-gray-200 text-gray-600'
                      }`}
                    >
                      {item.category}
                    </span>
                    <span className="text-sm text-gray-800 group-hover:text-brand-primary transition-colors">
                      {item.title}
                    </span>
                  </div>
                ))}
          ...
          <dl className="reveal divide-y divide-gray-100" style={{ transitionDelay: '0.08s' }}>
            {[
              ...
              <div key={label} className="flex flex-col sm:flex-row py-4 gap-2 sm:gap-0">
                <dt className="w-full sm:w-1/4 text-[10px] text-gray-400 font-bold tracking-[0.2em] uppercase flex-shrink-0 pt-0.5">
                  {label}
                </dt>
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <section
        className="py-32 bg-surface-dark relative overflow-hidden text-center text-white"
        aria-label="お問い合わせ"
      >
        {/* ブランドカラーのサブルな背景アクセント */}
        <div
          className="absolute top-0 left-0 w-1 h-full bg-brand-primary opacity-60"
          aria-hidden="true"
        />
        <div className="container relative z-10 mx-auto px-6 max-w-3xl">
          <p className="reveal text-[10px] text-brand-primary font-bold tracking-[0.3em] uppercase mb-5">
            Get in Touch
          </p>
          <h2
            className="reveal text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-6 tracking-[0.05em] leading-tight"
            style={{ transitionDelay: '0.08s' }}
          >
            ご相談をご希望の方へ
          </h2>
          <p
            className="reveal text-sm text-gray-400 mb-14 leading-relaxed"
          ...
          <div
            className="reveal flex flex-col sm:flex-row justify-center items-center gap-4"
            style={{ transitionDelay: '0.16s' }}
          >
            <Link
              href="/contact"
              className="w-full sm:w-auto px-10 py-4 bg-white text-gray-900 font-bold text-sm hover:bg-gray-100 hover:-translate-y-0.5 transition-all duration-300"
            >
              Webから問い合わせる
            </Link>
            <a
              href="tel:045-881-9952"
              className="w-full sm:w-auto px-10 py-4 bg-transparent border border-white/20 text-white font-bold text-sm hover:bg-white/8 hover:border-white/40 hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-2"
            >
