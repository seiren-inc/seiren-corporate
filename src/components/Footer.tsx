      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
          <div className="lg:col-span-2 space-y-6">
            <h3 className="text-white text-2xl font-bold tracking-wider">株式会社 清蓮</h3>
            ...
            <div className="pt-4">
              <a 
                ...
                className="inline-flex items-center gap-2 text-xl font-medium text-white hover:text-brand-primary transition-colors duration-300"
              >
          ...
          <div className="space-y-6">
            <h3 className="text-white font-semibold tracking-widest text-sm uppercase">事業領域</h3>
          ...
          <div className="space-y-6">
            <h3 className="text-white font-semibold tracking-widest text-sm uppercase">企業情報</h3>
            <nav className="flex flex-col space-y-4">
          ...
          <div className="space-y-6">
            <h3 className="text-white font-semibold tracking-widest text-sm uppercase">サポート</h3>
            <nav className="flex flex-col space-y-4">
